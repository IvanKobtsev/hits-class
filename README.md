...
1. ASP.NET Core backend (.NET 10)
   ...
   7. Logging via Serilog to:
      ...
      2. [Loggly](https://loggly.com) (free up to 250MB/day). You could check out logs [yourself](https://mcchitsclass.loggly.com/) (credentials: mcc.template.app@gmail.com/dBAeFm7_y5mq3)
1. React frontend
...
1. Rename all files/folders from 'HitsClass' to your project name.
...
1. Run backend (Open `webapi/Team13.HitsClass.sln` in Rider/Visual Studio and hit `F5`)
...
6. Disable Pipeline notifications in Azure (i.e. 'Run stage waiting for approval' and 'Manual validation Pending') https://dev.azure.com/mccsoft/HitsClass/_settings/notifications. Also disable them in your personal profile: https://dev.azure.com/mccsoft/_usersSettings/notifications
