...
Here's the documentation how Postgres enums are integrated into EFCore: https://www.npgsql.org/efcore/mapping/enum.html?tabs=tabid-1. So, for every new enum that you are adding to your domain entities you should also add it in DbContext:
