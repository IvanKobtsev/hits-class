...
12. Try to run the backend project (`webapi/Team13.HitsClass.slnx`) as usual (e.g. `F5` from VSCode/Rider/VisualStudio, assuming `Team13.HitsClass.App` is a startup project). Frontend should start automatically together with backend. If you run into issue, consult your teammate :)
