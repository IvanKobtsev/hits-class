...
It's quite common requirement to have a page with a list of items with ability to filter/sort them (and also switch between pages when there are many items). Common examples are google search results, or Azure Dev Ops work items list: ![img.png](filter-sorting-azure-work-items.png)
