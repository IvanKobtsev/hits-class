...
1. [Backend] Do not modify any existing files in [Setup](/webapi/src/Team13.HitsClass.App/Setup) folder. See the previous point for the reasons and workarounds (existing files in Setup folder are overwritten as well).
