...
# Team13.Webhooks library

Library Team13.Webhooks helps with sending out web hook calls and handle retries if they are needed.
...
1. Call `builder.Services.AddWebHooks();` from [Program.cs](../../webapi/src/Team13.HitsClass.App/Program.cs)
2. Call `builder.AddWebHookEntities(this.GetType());` from `OnModelCreating` method of your [DbContext](../../webapi/src/Team13.HitsClass.Persistence/HitsClassDbContext.cs)
