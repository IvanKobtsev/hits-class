...
import { throwException, isAxiosError } from '../query-client.types';
import { getAxios, getBaseUrl } from './helpers';

export function create(
  dto: Types.CreateProductDto,
  config?: AxiosRequestConfig | undefined,
): Promise<Types.ProductDto> {
...
export function search(
  ...
  if (lastStockUpdatedAt !== undefined && lastStockUpdatedAt !== null)
    url_ +=
      'LastStockUpdatedAt=' +
      encodeURIComponent(
        lastStockUpdatedAt ? '' + Types.formatDate(lastStockUpdatedAt) : '',
      ) +
      '&';
...
export function patchCreateRequestConfig(
...
export function patchDeleteRequestConfig(
  patch: (value: Partial<AxiosRequestConfig>) => Partial<AxiosRequestConfig>,
) {
...
export function patchSearchRequestConfig(
  patch: (value: Partial<AxiosRequestConfig>) => Partial<AxiosRequestConfig>,
) {
...
export function patchPatchRequestConfig(
  patch: (value: Partial<AxiosRequestConfig>) => Partial<AxiosRequestConfig>,
) {
...
export function patchGetRequestConfig(
  patch: (value: Partial<AxiosRequestConfig>) => Partial<AxiosRequestConfig>,
) {
