...
export function setResetTenantRequestConfig(
  value: Partial<AxiosRequestConfig>,
) {
  _requestConfigResetTenant = value;
}
export function patchResetTenantRequestConfig(
...
export function setCreateTestTenantRequestConfig(
  value: Partial<AxiosRequestConfig>,
) {
  _requestConfigCreateTestTenant = value;
}
export function patchCreateTestTenantRequestConfig(
  patch: (value: Partial<AxiosRequestConfig>) => Partial<AxiosRequestConfig>,
) {
