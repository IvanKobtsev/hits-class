...
export type RotateSecretWebHookQueryParameters = {
  id: string ;
}
 ...
 */
export function useSubscribeToEventMutation<TContext>(options?: Omit<UseMutationOptions<Types.WebHookSubscribedDto, unknown, Types.CreateWebHookDto, TContext>, 'mutationKey' | 'mutationFn'>): UseMutationResult<Types.WebHookSubscribedDto, unknown, Types.CreateWebHookDto, TContext> {
...
export function rotateSecretUrl(id: string): string {
...
export function rotateSecretMutationKey(id: string): MutationKey {
  return trimArrayEnd([
      'WebHookClient',
      'rotateSecret',
      id as any,
 ...
 */
export function useRotateSecretMutation<TContext>(id: string, options?: Omit<UseMutationOptions<string, unknown, void, TContext>, 'mutationKey' | 'mutationFn'>): UseMutationResult<string, unknown, void, TContext> {
  const key = rotateSecretMutationKey(id);
  ...
  return useMutation({
    ...options,
    mutationFn: () => Client.rotateSecret(id),
    mutationKey: key,
  });
}
  
type RotateSecret__MutationParameters = RotateSecretWebHookQueryParameters

/**
 * Rotate already generated signature secret.
 * @param id Subscription Id
 */
export function useRotateSecretMutationWithParameters<TContext>(options?: Omit<UseMutationOptions<string, unknown, RotateSecret__MutationParameters, TContext>, 'mutationKey' | 'mutationFn'> & { parameters?: RotateSecretWebHookQueryParameters}): UseMutationResult<string, unknown, RotateSecret__MutationParameters, TContext> {
  const key = rotateSecretMutationKey(options?.parameters?.id!);
...
return useMutation({
  ...options, 
  mutationFn: (data: RotateSecret__MutationParameters) => Client.rotateSecret(data.id ?? options?.parameters?.id!),
  mutationKey: key,
});
}