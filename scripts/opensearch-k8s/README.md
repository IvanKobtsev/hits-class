...
1. Add Role for writing logs
   ...
   - Username: hitsclass-dev
   - Password
   - Backend-roles: hitsclass-dev-write

   1. Go back to Security tab -> Roles, find created role `hitsclass-dev-write`. Open tab `Mapped users` and add mapping to created user `hitsclass`.
...
1. Add your logs to Discover
   ...
   1. Define a pattern like `hitsclass-*`
