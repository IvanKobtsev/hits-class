...
function updateFrom_1p5_to_1p6(
  ...
  removePackageReference(
    `webapi/Lib/Testing/Team13.Testing/Team13.Testing.csproj`,
    'Newtonsoft.Json',
  );
...
function updateFrom_1p7_to_1p8(
  ...
  fs.removeSync(`webapi/Lib/WebHooks/Team13.WebHooks/IWebHookSender.cs`);
  fs.removeSync(`webapi/Lib/WebHooks/Team13.WebHooks/WebHookSender.cs`);
  fs.removeSync(
    `webapi/Lib/WebHooks/Team13.WebHooks/Interceptors/IWebHookInterceptor.cs`,
  );
  fs.removeSync(
    `webapi/Lib/WebHooks/Team13.WebHooks/Interceptors/WebHookInterceptor.cs`,
  );
  fs.removeSync(
    `webapi/Lib/WebHooks/Team13.WebHooks/Processing/WebHookHostedService.cs`,
  );
  fs.removeSync(
    `webapi/Lib/WebHooks/Team13.WebHooks/Processing/WebHookConfiguration.cs`,
  );
  fs.removeSync(
    `webapi/Lib/WebHooks/Team13.WebHooks/Domain/WebHookAdditionalData.cs`,
  );
  fs.removeSync(
    `webapi/Lib/WebApi/Team13.WebApi/Serialization/HttpClientExtensions.cs`,
  );
}
