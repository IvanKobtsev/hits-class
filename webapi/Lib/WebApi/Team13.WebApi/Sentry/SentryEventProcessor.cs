...
namespace Team13.WebApi.Sentry;
...
internal class SentryEventProcessor : ISentryEventProcessor
{
    ...
    public SentryEventProcessor(IConfiguration configuration, ILogger<SentryEventProcessor> logger)
    {
        _logger = logger;
    ...
    public SentryEvent Process(SentryEvent @event)
    {
        ...
        if (!string.IsNullOrEmpty(message))
        {
            ...
            if (@event.Logger == "Team13.MessageBus.ReceiveObserverLogging")
            {
