...
using Team13.HitsClass.App.Features.Products.Dto;
using Team13.HitsClass.App.Features.Webhooks;
...
using Team13.WebHooks.Publisher;

namespace Team13.HitsClass.App.Features.Products;

[Log]
public class ProductService
{
    private readonly HitsClassDbContext _dbContext;
    private readonly DbRetryHelper<HitsClassDbContext, ProductService> _retryHelper;
    ...
    public ProductService(
        ...
        DbRetryHelper<HitsClassDbContext, ProductService> retryHelper,
    ...
    public async Task<ProductDto> Create(CreateProductDto dto)
    {
        ...
        var productId = await _retryHelper.RetryInTransactionAsync(
            async (db, logger) =>
            {
                var isProductWithSameNameExists = await db.Products.AnyAsync(x =>
                    x.Title == dto.Title
                );
