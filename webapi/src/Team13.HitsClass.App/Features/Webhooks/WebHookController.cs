...
{
    private readonly IWebHookManager<HitsClassWebHookSubscription> _webHookManager;

    public WebHookController(IWebHookManager<HitsClassWebHookSubscription> webHookManager)
    {
