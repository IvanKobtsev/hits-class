...
namespace Team13.HitsClass.Persistence.Migrations
{
    ...
    [Migration("20260623103253_AddCommentToPeerReview")]
    partial class AddCommentToPeerReview
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "publication_type", new[] { "announcement", "assignment", "team_assignment" });
            ...
            modelBuilder.Entity("Team13.HitsClass.Domain.Criteria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Team13.HitsClass.Domain.CriteriaEvaluation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Team13.HitsClass.Domain.Invitation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Team13.HitsClass.Domain.PeerReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Team13.HitsClass.Domain.PeerReviewAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("DefendantUserId")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("PublicationId", "JuryUserId", "DefendantUserId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Team13.HitsClass.Domain.Team", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Team13.HitsClass.Domain.CriteriaEvaluation", b =>
                {
                    b.HasOne("Team13.HitsClass.Domain.Criteria", "Criteria")
                        .WithMany()
                        .HasForeignKey("CriteriaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Team13.HitsClass.Domain.PeerReview", "PeerReview")
            ...
            modelBuilder.Entity("Team13.HitsClass.Domain.Invitation", b =>
                {
                    b.HasOne("Team13.HitsClass.Domain.Team", "Team")
                        .WithMany()
            ...
            modelBuilder.Entity("Team13.HitsClass.Domain.PeerReview", b =>
                {
                    b.HasOne("Team13.HitsClass.Domain.PeerReviewAssignment", "Assignment")
                        .WithMany()
            ...
            modelBuilder.Entity("Team13.HitsClass.Domain.PeerReviewAssignment", b =>
                {
                    b.HasOne("Team13.HitsClass.Domain.User", "DefendantUser")
                        .WithMany()
                        .HasForeignKey("DefendantUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Team13.HitsClass.Domain.User", "JuryUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Team13.HitsClass.Domain.Team", b =>
                {
                    b.HasOne("Team13.HitsClass.Domain.User", "Captain")
                        .WithMany()
            ...
            modelBuilder.Entity("TeamUser", b =>
                {
                    ...
                    b.HasOne("Team13.HitsClass.Domain.Team", null)
                        .WithMany()
                        .HasForeignKey("TeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
